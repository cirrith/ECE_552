...
/		OUTPUTS: 
********************************************************************************************************/
module Processor_Control (OP_Code, OP_Min, Write_Reg_Sel, Reg_Write, PC_Code, Comp_Code, ALU_OP_Code, ALU_B_Src, Pass_Thr_Sel, Imm_Sel, Check_A, Check_B, Mem_Read, Mem_Write, WB_Sel, createdump, halt);
...
/*	
	...
	Check_A - Whether to check Rs for Stall, being used in instruction
		0 - Nope
		1 - Check it
		
	Check_B - Whether to check Rt for Stall, being used in instruction
		0 - Nope
		1 - Check it
