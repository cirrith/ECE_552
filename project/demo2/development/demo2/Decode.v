...
********************************************************************************************************/
module Decode (clk, rst, Instruction, PC2, Write_Reg_In, Write_Data, Reg_Write_In, Reg_1_Data, Reg_2_Data, Reg_1_Src, Reg_2_Src, Immediate, Write_Reg_Out, Reg_Write_Out, ALU_OP_Code, Pass_Thr_Sel, ALU_B_Src, Comp_Code, PC_Code, Mem_Write, Mem_Read, WB_Sel, createdump, halt);
