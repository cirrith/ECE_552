...
/		Yea this complex
********************************************************************************************************/
module Decode_Execute_Blade (clk, rst, Flush, Stall, ALU_B_Src_Dec, ALU_OP_Code_Dec, Immediate_Dec, Check_A_Dec, Check_B_Dec, Pass_Thr_Sel_Dec, PC2_Dec, Reg_1_Data_Dec, Reg_2_Data_Dec, Reg_1_Src_Dec, Reg_2_Src_Dec, Mem_Write_Dec, Mem_Read_Dec, createdump_Dec, Reg_Write_Dec, WB_Sel_Dec, Write_Reg_Dec, halt_Dec, ALU_B_Src_Exe, ALU_OP_Code_Exe, Immediate_Exe, Check_A_Exe, Check_B_Exe, Pass_Thr_Sel_Exe, PC2_Exe, Reg_1_Data_Exe, Reg_2_Data_Exe, Reg_1_Src_Exe, Reg_2_Src_Exe, Mem_Write_Exe, Mem_Read_Exe, createdump_Exe, Reg_Write_Exe, WB_Sel_Exe, Write_Reg_Exe, halt_Exe);
...
//Execute
	...
	dff_pipe check_a			(.clk(clk), .rst(rst), .Flush(Flush), .Stall(Stall), .d(Check_A_Dec), 		.q(Check_A_Exe));
	dff_pipe check_b			(.clk(clk), .rst(rst), .Flush(Flush), .Stall(Stall), .d(Check_B_Dec), 		.q(Check_B_Exe));
